...
- [字体内嵌 mono + 字重而非超采样](font-cjk-mono.md) — Sarasa Mono SC SemiBold(子集 2MB)退役 Noto;fontdue 解析式 AA 封顶目标 px,超采样不锐化小字,字重才是杠杆;DPI 物理栅格已支持(2026-09-22 HiDPI 贯通, A3 取整图集零改动)
