...
Spec: `docs/specs/pomodoro-scene-motion-bonfire.md` / Plan: `tasks/plan-pomodoro-scene-motion-bonfire.md`

- [ ] T1: 框架篝火动效能力(暗启动)
  - Acceptance: uniform 32B + `fire_intensity` 通道 + wgsl 火效段(呼吸+余烬,门控 fire_intensity>0);`MOTION_WRAP_SECS` 更名;`fire_intensity==0` 输出与静态逐像素一致;新增单测全绿
