...
pub const SCENES: [SceneSpec; 9] = [
    ...
    SceneSpec {
        ...
        palette: ScenePalette {
            base: Color::from_srgb8(74, 84, 104),
            accent: Color::from_srgb8(180, 205, 225),
            text_primary: Color::from_srgb8(240, 246, 252),
            text_secondary: Color::from_srgb8(186, 198, 214),
            surface: Color::rgba(0.0, 0.0, 0.0, 0.25),
            surface_input: Color::rgba(0.0, 0.0, 0.0, 0.38),
            backdrop_light: Color::from_srgb8(99, 110, 127),
            backdrop_dark: Color::from_srgb8(23, 39, 47),
        },
    },
    SceneSpec {
        name: "沙漠",
    ...
    SceneSpec {
        ...
        palette: ScenePalette {
            ...
            surface: Color::rgba(1.0, 1.0, 1.0, 0.5),
            surface_input: Color::rgba(1.0, 1.0, 1.0, 0.8),
            backdrop_light: Color::from_srgb8(224, 239, 244),
            backdrop_dark: Color::from_srgb8(121, 162, 160),
        },
    },
];
